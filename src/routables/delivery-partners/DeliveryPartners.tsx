...
const DeliveryPartnersComponent: FC<{ user: User }> = ({ user }): ReactElement => {

    const nav = useNavigate();

    useEffect(() => {
        if (!AuthSvc.getUser() || AuthSvc.getUser().account.type !== AccountType.DeliveryPartner) {
            nav('/');
        }
    });
...
export default DeliveryPartnersComponent;